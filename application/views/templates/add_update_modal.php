<button type="button" onclick="prepareSaveForm()" class="btn btn-success" style="margin-bottom: 10px;float:right;" data-toggle="modal" data-target="#addUpdateTeamModal">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="addUpdateTeamModalTitle" class="modal-title"><?php echo $addModalCaption; ?></h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnUpdate" class="btn btn-primary" onclick="updateForm()">Update Team</button>
